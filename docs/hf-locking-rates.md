...
| `LOCK_TOLERANCE` | 5e-6 THz = **5 MHz** default | Convergence tolerance; per-port overrides in `LOCK_TOLERANCE_BY_PORT` (TiSa_1 ch4 = **1 MHz**) via `lock_tolerance(port)` | `workers.py:20-32` |
